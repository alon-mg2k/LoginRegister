...
//Metodo para crear usuario Espectador
    private void CreateAccount() {
        ...
        if(!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !confpassword.isEmpty()) {
            if (password.length() >= 6) {
                ...
                Toast.makeText(RegisterActivity.this, R.string.msj_password, Toast.LENGTH_SHORT).show();
            }
        } else {
            //Mensaje que se muestra si no se llenó la información solicitada en todos los campos
            Toast.makeText(RegisterActivity.this, R.string.campos_complete, Toast.LENGTH_SHORT).show();
        }
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    mDatabase.child(TipoUs).child(id).setValue(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task2) {
                            ...
                            if(task2.isSuccessful()){
                                ...
                                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(RegisterActivity.this, R.string.user_Registro,Toast.LENGTH_SHORT).show();
                                        }else{
                                ...
                                Toast.makeText(RegisterActivity.this, R.string.datos_incorrectos, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                    ...
                    Toast.makeText(RegisterActivity.this, R.string.no_registro_user, Toast.LENGTH_SHORT).show();
