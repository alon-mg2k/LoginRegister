...
public class RDUActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rduactivity);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (!device.equals(getResources().getString(R.string.str_spinner_selectdevice))) {
                            queryInfo.clear();
                            ObtainData("Device (Dynamic)",device,queryInfo);
                        }
                    }
                });
            }
        ...
        editText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!editText.getText().equals(null) || editText.getText().equals("")) {
                    ...
                    pickerDialog = new DatePickerDialog(RDUActivity.this, RDUActivity.this, year, month, day);
                    pickerDialog.show();
                }
            }
        });
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                ObtainData("Device (Dynamic)", date, queryInfo);
